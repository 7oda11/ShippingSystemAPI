...
namespace ShippingSystem.Core.Migrations
{
    ...
    [Migration("20250702200123_adding Group, Persmission and Group Permission")]
    partial class addingGroupPersmissionandGroupPermission
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShippingSystem.Core.Entities.Group", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ShippingSystem.Core.Entities.GroupPermission", b =>
                {
                    b.Property<int>("GroupId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ShippingSystem.Core.Entities.Permission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ShippingSystem.Core.Entities.Employee", b =>
                {
                    ...
                    b.HasOne("ShippingSystem.Core.Entities.Group", "Group")
                        .WithMany("Employees")
            ...
            modelBuilder.Entity("ShippingSystem.Core.Entities.GroupPermission", b =>
                {
                    ...
                    b.HasOne("ShippingSystem.Core.Entities.Permission", "Permission")
                        .WithMany("GroupPermissions")
