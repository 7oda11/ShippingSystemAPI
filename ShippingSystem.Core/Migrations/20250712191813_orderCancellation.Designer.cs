...
namespace ShippingSystem.Core.Migrations
{
    ...
    [Migration("20250712191813_orderCancellation")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShippingSystem.Core.Entities.OrderCancellation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ShippingSystem.Core.Entities.OrderCancellation", b =>
                {
                    b.HasOne("ShippingSystem.Core.Entities.Order", "Order")
                        ...
                        .HasForeignKey("ShippingSystem.Core.Entities.OrderCancellation", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
