        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CancelledOrderPercentage = table.Column<float>(type: "real", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_DeliveryMen_Cities_CityID",
                        column: x => x.CityID,
            ...
            migrationBuilder.CreateTable(
                name: "EmployeeAssignOrderToDeliveries",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeeAssignOrderToDeliveries", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EmployeeAssignOrderToDeliveries_DeliveryMen_DeliveryID",
                        column: x => x.DeliveryID,
                        principalTable: "DeliveryMen",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_EmployeeAssignOrderToDeliveries_Employees_EmployeeID",
                        column: x => x.EmployeeID,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_EmployeeAssignOrderToDeliveries_Orders_OrderID",
                        column: x => x.OrderID,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderCustomerPhones", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OrderCustomerPhones_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeAssignOrderToDeliveries_DeliveryID",
                table: "EmployeeAssignOrderToDeliveries",
                column: "DeliveryID");

            migrationBuilder.CreateIndex(
                name: "IX_EmployeeAssignOrderToDeliveries_EmployeeID",
                table: "EmployeeAssignOrderToDeliveries",
                column: "EmployeeID");

            migrationBuilder.CreateIndex(
                name: "IX_EmployeeAssignOrderToDeliveries_OrderID",
                table: "EmployeeAssignOrderToDeliveries",
                column: "OrderID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderCustomerPhones_OrderId",
                table: "OrderCustomerPhones",
                column: "OrderId");
